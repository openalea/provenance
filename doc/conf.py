...
# -*- coding: utf-8 -*-
#
# Package (Undefined, u'provenance') documentation build configuration file, created by
...
project = u'openalea.provenance'
copyright = u'2015, openalea.provenance'
...
# [howto/manual]).
latex_documents = [
    ('index', 'provenance.tex',
     u'provenance Documentation',
...
texinfo_documents = [
    ('index', 'provenance',
     ...
     u'revesansparole',
     'provenance',
     'Implementation of provenance for openalea workflows',
     'Miscellaneous'),
]
