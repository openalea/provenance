...
tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd provenance
    (dvlpt) provenance$ flake8
    (dvlpt) provenance$ nosetests
    (dvlpt) provenance$ tox
...
3. The pull request should work for Python 2.7, 3.4, and 3.5. Check
   https://travis-ci.org/openalea/provenance/pull_requests
...
.. _issues: https://github.com/openalea/provenance/issues
